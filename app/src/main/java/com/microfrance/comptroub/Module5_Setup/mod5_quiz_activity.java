...
public class mod5_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod5_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod5_quiz);
        ...
        dialog = new Dialog(mod5_quiz_activity.this);
        ...
        questionsList.addAll(mod5_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod5_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod5_quiz_activity.this, mod5_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod5_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
