...
public class mod8_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod8_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod8_quiz);
        ...
        dialog = new Dialog(mod8_quiz_activity.this);
        ...
        questionsList.addAll(mod8_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod8_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod8_quiz_activity.this, mod8_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod8_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
