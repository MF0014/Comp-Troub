...
public class mod6_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod6_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod6_quiz);
        ...
        dialog = new Dialog(mod6_quiz_activity.this);
        ...
        questionsList.addAll(mod6_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod6_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod6_quiz_activity.this, mod6_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod6_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
