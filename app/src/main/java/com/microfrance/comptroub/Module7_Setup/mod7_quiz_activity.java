...
public class mod7_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod7_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod7_quiz);
        ...
        dialog = new Dialog(mod7_quiz_activity.this);
        ...
        questionsList.addAll(mod7_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod7_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod7_quiz_activity.this, mod7_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod7_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
