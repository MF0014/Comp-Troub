...
import com.microfrance.comptroub.Module3_Setup.mod3_quiz_result;
import com.microfrance.comptroub.R;

public class mod3_quiz_result extends AppCompatActivity {

    private TextView scoreTxt;
    private int mod3_score; // Declare mod1_score without initialization
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod3_quiz_result);
    ...
    protected void onResume() {
        ...
        mod3_score = prefs.getInt("module3score", 0);
        // Update the scoreTxt with the loaded score
        scoreTxt.setText(mod3_quiz_activity.score + "/5");
    }

    @Override
    public void finish() {
        // Set mod1_score to the current score before finishing
        mod3_score = mod3_quiz_activity.score;
        // Save completion status and score in SharedPreferences
        SharedPreferences.Editor editor = getSharedPreferences(SHARED_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putBoolean("module3Completed", true);
        editor.putInt("module3Score", mod3_score);
        editor.apply();

        Intent intent = new Intent(this, MainActivity.class);
        intent.putExtra("SCORE", mod3_score);
