...
public class mod4_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod4_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod4_quiz);
        ...
        dialog = new Dialog(mod4_quiz_activity.this);
        ...
        questionsList.addAll(mod4_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod4_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod4_quiz_activity.this, mod4_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod4_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
