...
import com.microfrance.comptroub.Module1_Setup.mod1_questions;
import com.microfrance.comptroub.Module1_Setup.mod1_quiz_activity;
import com.microfrance.comptroub.Module1_Setup.mod1_quiz_result;
...
public class mod2_quiz_activity extends AppCompatActivity {
    ...
    private final List<mod2_questions> questionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod2_quiz);
        ...
        dialog = new Dialog(mod2_quiz_activity.this);
        ...
        questionsList.addAll(mod2_questionLists.getQuestionsList());
    ...
    public void nextQuestion() {
        if (questionTracker < questionsList.size() && questionTracker < 5) {
            mod2_questions currentQuestion = questionsList.get(questionTracker);
            ...
            questionListEraser();
            finish();
            Intent intent = new Intent(mod2_quiz_activity.this, mod2_quiz_result.class);
    ...
    private void submitOption() {
        ...
        mod2_questions currentQuestion = questionsList.get(questionTracker - 1); // Subtract 1 because questionTracker was incremented after displaying the question
